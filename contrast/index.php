...
?>
    <main>
        <div class="single-column">
            <div class="column">
                <!-- Section: Introduction to Contrast -->
                <section class="paragraph">
                    <h1>The CRAPsite - Contrast</h1>
                    <p class="contrast-p">Contrast is an essential principle in visual design, allowing for elements to stand out from one another using several different design aspects. It is a fundamental method to allow certain areas of a design to stand out while allowing other sections to fade into the background. At its core, contrast creates meaningful differences between design elements using color, size, shape, texture, and typography to guide attention, establish hierarchy, and enhance visual interest.</p>
                    <!-- Embedded Video for Contrast -->
                ...
                <!-- Section: Visual Hierarchy Through Color Contrast -->
                <section class="paragraph">
                    <h2 class="interaction-h2">Visual Hierarchy Through Color Contrast</h2>
                    <p class="contrast-p">Color is the element most frequently and immediately associated with contrast. It is rightfully so, since color is an extremely powerful tool for directing the eye, creating emotional responses, and enhancing accessibility to designs. The key for effective color usage to create contrast is not just selecting opposing colors, but understanding how color combinations work to affect readability and visual impact while maintaining a harmonious overall design. Basic color theory will tell you that green and red are complementary colors with excellent contrast, however, a good designer knows that there will be an association of red and green with Christmas. This may be a boon to your design if you are designing for the holidays, but if you are creating a delicate and feminine perfume website, then pinks, soft blues, and whites will be a better choice for your design.</p>
                </section>
                
                <!-- Section: Size and Scale: Creating Dynamic Tension -->
                <section class="paragraph">
                    <h2 class="interaction-h2">Size and Scale: Creating Dynamic Tension</h2>
                    <p class="contrast-p">Size contrast creates dynamic relationships between elements, establishing clear hierarchical structures within designs. By varying the scale of elements significantly, designers can create focal points that naturally draw the eye and guide users through content. This principle is particularly effective in typography, where size differences between headlines and body text can dramatically improve readability and information flow.                    </p>
                    <img src="../assets/images/contrast1.jpg" alt="Contrast Graphic" class="paragraph-img">
                </section>
                
                <!-- Section: Textural and Stylistic Contrast -->
                <section class="paragraph">
                 ...
                 <!-- Contrast Images showing bad, mid, good contrast -->
        ...
        <!-- Interactive Panel to Adjust Contrast -->
        <div class="interaction-panel">
            <div class="column">
                ...
                <div class="control-section">
                    ...
                    <!-- Radio buttons for switching Text Color -->
                    ...
                    <!-- Radio buttons for switching Font Weight of headers-->
                    ...
                    <!-- Radio buttons for switching last Image -->
